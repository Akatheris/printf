...
/*   Updated: 2018/06/20 16:06:37 by mlauer           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char*		ft_itoa_base(int base, intmax_t n, char sign, int len, int neg)
{
	char				*str;
	char				*basel;
...
char		*ft_itoa_base_st(t_arg *arg, int neg,intmax_t n)
{
	int			count;
	char		sign;
	uintmax_t	v;
	...
	if (n < 0)
		...
		v = n;
	return (ft_itoa_base(base, v, sign, count, neg));
}
